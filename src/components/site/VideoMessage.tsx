        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
          ...
          <div data-aos="fade-left">
            ...
            <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
              "প্রিয় ভাই ও বোনেরা, আপনাদের ভালোবাসা ও বিশ্বাসই আমার পথচলার
              শক্তি। আমি প্রতিশ্রুতিবদ্ধ — এই এলাকার প্রতিটি মানুষের কল্যাণে কাজ
              করে যাব। কোনো সমস্যা ছোট নয়, কোনো অভিযোগ উপেক্ষিত নয়।"
            </p>
